...
XmBDFEditor jest bazującym na Motifie edytorem fontów BDF z
ulepszeniami:
- Kilka fontów równocześnie może być załadowanych z linii komend.
- Kilka fontów może być otwartych równocześnie.
- Wycinanie i wklejanie glyphsów pomiędzy fontami.
- Kilka edytorów glyph bitmap może być otwartych równocześnie.
- Wycinanie i wklejanie pomiędzy edytorami glyph bitmap.
- Automatyczna korekcja miar podczas ładowania fontu.
- Generacja nazw XLFD dla fontów bez takich nazw.
- Aktualizacja nazw fontów XLFD w właściwościach fontu.
- Aktualizacja właściwości fontu na podstawie nazwy fontu XLFD.
- Edytor właściwości fontów.
- Edytor komentarzy fontów.
- Wsparcie dla niezakodowanych glyphsów (KODOWANIE z -1).
- Wyświetlanie kodowania glyphów ósemkowo, decymalnie lub
  heksadecymalnie.
- Wbudowana pomoc.
